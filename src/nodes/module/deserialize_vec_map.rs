...
pub(crate) fn deserialize_vec_map<'de, D>(deserializer: D) -> Result<VecMap<usize, usize>, D::Error>
where
    D: Deserializer<'de>,
{
    ...
    impl<'de> Visitor<'de> for VecMapVisitor {
        type Value = VecMap<usize, usize>;
